...
import {
    ...
    KLineStyle, KLineWidth, KRotation, KShadow, KStyle, KStyleRef, KTextStrikeout, KTextUnderline, KVerticalAlignment, LineCap, LineJoin, LineStyle, VerticalAlignment, KGraphElement, KNode
} from './kgraph-models';
import {
 ...
 * @param context The rendering context.
 */
export function getSvgColorStyles(styles: KStyles, context: KGraphRenderingContext, parent: KGraphElement): ColorStyles {
